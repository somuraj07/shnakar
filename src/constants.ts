...
export const PROJECTS: Project[] = [
  {
    ...
    image: "/photos/project-erp-main.svg",
  ...
  },
  {
    ...
    image: "/photos/project-sms-qr.svg",
  ...
  },
  {
    ...
    image: "/photos/project-blood-module.svg",
  },
  {
    title: "SGI Donars",
    description: "Blood donor discovery and emergency contact platform built for SGI college and a super specialty hospital.",
    stack: ["React", "Node.js", "MongoDB", "Express", "REST API"],
    image: "/photos/project-sgi-donars.svg",
    link: "https://sgidonars.smkalyankar.in/",
  },
  {
    title: "SMK Blog Platform",
    description: "Content and blogging website used to publish updates, stories, and informational posts.",
    stack: ["Next.js", "Node.js", "PostgreSQL", "Tailwind CSS"],
    image: "/photos/project-blog.svg",
    link: "https://blog.smkalyankar.in/",
  },
  {
    title: "AI Mock Interview",
    description: "Practice interview platform with AI-powered mock rounds for student and job preparation.",
    stack: ["Next.js", "TypeScript", "Node.js", "AI APIs"],
    image: "/photos/project-mock.svg",
    link: "https://mock.smkalyankar.in/",
  },
  {
    title: "SSE College Website",
    description: "Official website for Sanskriti School of Engineering, designed for admissions and campus information.",
    stack: ["React", "TypeScript", "Tailwind CSS", "CMS"],
    image: "/photos/project-sse.svg",
    link: "https://sse.smkalyankar.in/",
  },
  {
    title: "SSE Stocks",
    description: "Inventory and stock management system for college items and goods tracking.",
    stack: ["Next.js", "Node.js", "PostgreSQL", "Role-based Access"],
    image: "/photos/project-sse-stocks-main.svg",
    link: "https://ssestocks.smkalyankar.in/",
  },
  {
    title: "Unity 7 ERP (U7)",
    description: "Complete multi-tenant school ERP and management system handling end-to-end academic operations.",
    stack: ["Next.js", "Node.js", "Prisma", "PostgreSQL", "Redis", "JWT"],
    image: "/photos/project-u7.svg",
    link: "https://u7.smkalyankar.in/",
  },
  {
    title: "SLR Saree Store",
    description: "E-commerce platform for saree catalog browsing, shopping, and order flow management.",
    stack: ["Next.js", "Node.js", "PostgreSQL", "Payments"],
    image: "/photos/project-slr.svg",
    link: "https://slr.smkalyankar.in/",
  },
  {
    title: "SMS Platform",
    description: "Campus management website supporting day-to-day digital workflows and communication.",
    stack: ["React", "Node.js", "PostgreSQL", "JWT", "RBAC"],
    image: "/photos/project-sms.svg",
    link: "https://sms.smkalyankar.in/",
  },
  {
    title: "SSB College Website",
    description: "Official website for Sanskriti School of Business with institute details and student information.",
    stack: ["React", "TypeScript", "Tailwind CSS", "SEO"],
    image: "/photos/project-ssb.svg",
    link: "https://ssb.smkalyankar.in/",
  },
  {
    title: "SGI SMS (QR Management)",
    description: "QR-based college management system for identity, attendance, and student workflow operations.",
    stack: ["Next.js", "Node.js", "PostgreSQL", "QR Workflows", "JWT", "RBAC"],
    image: "/photos/project-sgisms.svg",
    link: "https://sgisms.smkalyankar.in/",
  },
];
